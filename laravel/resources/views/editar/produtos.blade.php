...
{!! Form::model($produto, array('id' => 'formulario', 'route' => array('updateProduto', $produto->id), 'method' => 'PUT', 'files' => true)) !!}
	{!! Form::label('Nome: ') !!}
	...
	{!! Form::select('categoria', array('1' => 'Sanduíches', '2' => 'Bebidas', '3' => 'Porções', '4' => 'Pratos'), null, array("class" => "form-control", "style" => "width: 300px")) !!}
{{-- 	{!! Form::text('categoria', '', array('class' => 'form-control', 'style' => 'width: 400px', 'maxlength' => '45')) !!} --}}
	<br>
