$(document).ready(
	function() {
		...
		function salvarItens() {
			...
			var precoCompra = $("#textoTotalCompra").text();
			var precoVenda = $("#textoTotalVenda").text();
			console.log(precoCompra.substr(precoCompra.length-4, precoCompra.length));
			console.log(precoVenda);
			$("[name='precoCompra']").val("");
			$("#divPrecos").css('display', 'initial');
